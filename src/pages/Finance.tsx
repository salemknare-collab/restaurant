...
import { Wallet, Plus, Search, Edit2, Trash2, ArrowRightLeft, Building2, CreditCard, X, Truck } from 'lucide-react';
...
export default function Finance() {
  ...
  const [activeTab, setActiveTab] = useState<'accounts' | 'drivers'>('accounts');
